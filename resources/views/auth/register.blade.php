...
rounded-lg shadow-lg">
  ...
  <h1 class="text-3xl text-center font-bold">Registro de Usuario</h1>
  ...
  <form class="mt-4" method="POST" action="">
    ...
    text-lg placeholder-gray-900 p-2 my-2 focus:bg-white" placeholder="Dirección"
    id="email" name="email">
    ...
    placeholder="Confirmación de Contraseña" id="password_confirmation" 
